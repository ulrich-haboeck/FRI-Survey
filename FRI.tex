...
\]
where the Johnson proximity is $m=1,427$. 
...
%%
%% There seems something missing, when applied to the PCS framework. Similar to the AIR soundness, one needs to 
%% integrate the degree of the denomiator in the testing bound (leading to slightly tighter testing). Needs to be checked!
%%
